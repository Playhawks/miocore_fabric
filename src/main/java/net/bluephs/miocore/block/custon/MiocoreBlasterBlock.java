package net.bluephs.miocore.block.custon;

import net.bluephs.miocore.block.entity.MiocoreBlasterBlockEntity;
...
public class MiocoreBlasterBlock extends BlockWithEntity implements BlockEntityProvider {
    public static final DirectionProperty FACING = Properties.HORIZONTAL_FACING;

    public MiocoreBlasterBlock(Settings settings) {
        super(settings);
    }
    ...
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        if (state.getBlock() != newState.getBlock()) {
            ...
            if (blockEntity instanceof MiocoreBlasterBlockEntity) {
                ItemScatterer.spawn(world, pos, (MiocoreBlasterBlockEntity)blockEntity);
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new MiocoreBlasterBlockEntity(pos, state);
    }
