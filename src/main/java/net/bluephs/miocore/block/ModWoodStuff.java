...
public class ModWoodStuff {
    ...
    public static final Block MAHAGONY_STAIRS = registerBlock("mahagony_stairs",
            new ModStairsBlock(ModWoodStuff.MAHAGONY_PLANKS.getDefaultState(),
    ...
    public static final Block ASH_TREE_STAIRS = registerBlock("ash_tree_stairs",
            new ModStairsBlock(ModWoodStuff.ASH_TREE_PLANKS.getDefaultState(),
                    FabricBlockSettings.of(Material.WOOD).strength(4.5f).requiresTool()), ModItemGroup.MIO);
    ...
    public static final Block CHERRY_TREE_STAIRS = registerBlock("cherry_tree_stairs",
            new ModStairsBlock(ModWoodStuff.CHERRY_TREE_PLANKS.getDefaultState(),
                    FabricBlockSettings.of(Material.WOOD).strength(4.5f).requiresTool()), ModItemGroup.MIO);
    ...
    public static void registerModWoodStuff() {
        MioCore.LOGGER.info("Registering Mod Wood Stuff for " + MioCore.MOD_ID);
    }
}
