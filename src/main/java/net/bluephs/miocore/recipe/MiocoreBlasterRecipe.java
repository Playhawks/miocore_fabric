...
public class MiocoreBlasterRecipe implements Recipe<SimpleInventory> {
    private final Identifier id;
    private final ItemStack output;
    private final DefaultedList<Ingredient> recipeItems;

    public MiocoreBlasterRecipe(Identifier id, ItemStack output, DefaultedList<Ingredient> recipeItems){
        this.id = id;
        this.output = output;
    ...
    public static class Serializer implements RecipeSerializer<MiocoreBlasterRecipe> {
        ...
        @Override
        public MiocoreBlasterRecipe read(Identifier id, JsonObject json) {
        ...
        @Override
        public void write(PacketByteBuf buf, MiocoreBlasterRecipe recipe) {
